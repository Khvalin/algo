...
func TestSampleCustom26(t *testing.T) {
	...
	beginWord := "qa"
	endWord := "sq"
	wordList := []string{"si", "go", "se", "cm", "so", "ph",
		"mt", "db", "mb", "sb", "kr", "ln", "tm", "le", "av",
		"sm", "ar", "ci", "ca", "br", "ti", "ba", "to", "ra",
		"fa", "yo", "ow", "sn", "ya", "cr", "po", "fe", "ho",
		"ma", "re", "or", "rn", "au", "ur", "rh", "sr", "tc",
		"lt", "lo", "as", "fr", "nb", "yb", "if", "pb", "ge",
		"th", "pm", "rb", "sh", "co", "ga", "li", "ha", "hz",
		"no", "bi", "di", "hi", "qa", "pi", "os", "uh", "wm",
		"an", "me", "mo", "na", "la", "st", "er", "sc", "ne",
		"mn", "mi", "am", "ex", "pt", "io", "be", "fm", "ta",
...
func TestSampleCustom27(t *testing.T) {
	beginWord := "hot"
	endWord := "dog"
	...
	if 3 == res {
		t.Log("Test 27 passed")
	} else {
		t.Error("fail, got ", res, " expected ", 3)
	}
}

func TestSampleCustom28(t *testing.T) {
	beginWord := "cat"
	endWord := "fin"
...
func TestSampleCustom21(t *testing.T) {
	beginWord := "cet"
	endWord := "ism"
